...
void AveragingNode::initialize ()
{
	...
	mPhase = 0;
	block = 0;
	//stateBuffer = audio::Buffer ( 2048, 2 );
}

void AveragingNode::process ( ci::audio::Buffer *buffer )
{
